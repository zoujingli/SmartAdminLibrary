...
def version_highlights(repository: str, profile: RepositoryProfile, files: list[str], grouped: dict[str, list[str]]) -> list[str]:
    ...
    if repository == DEVELOPER_REPO and has_path(files, 'plugin/Asset/', 'plugin/Customer/', 'plugin/License/', 'plugin/Material/', 'plugin/Points/', 'plugin/Project/', 'plugin/Smart/', 'plugin/Website/', 'plugin/WechatService/'):
